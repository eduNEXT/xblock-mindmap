...
"""
xblock-mindmap documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-mindmap',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/xblock-mindmap",
...
#
# html_title = 'xblock-mindmap v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Mind Map XBlock for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'mindmap'),
                os.path.join(root_path, 'mindmap/migrations')])
