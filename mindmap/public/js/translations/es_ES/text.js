...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Weight": "Peso",
    "Whether the component is scorable. If is scorable, the student can submit the mind map and receive a score from the instructor. If it is not scorable, the student only can save the mind map. Important: Changing from scorable to not scorable, the progress of the students who have already been assigned a grade will not be reset.": "Si el componente es calificable. Si es calificable, el estudiante puede enviar el mapa mental y recibir una calificaci\u00f3n del instructor. Si no es calificable, el estudiante solo puede guardar el mapa mental. Importante: Si cambia de calificable a no calificable, no se restablecer\u00e1 el progreso de los estudiantes a los que ya se les haya asignado una calificaci\u00f3n",
    ...
    "Whether the student has submitted their submission.": "Si el estudiante ha realizado su env\u00edo.",
